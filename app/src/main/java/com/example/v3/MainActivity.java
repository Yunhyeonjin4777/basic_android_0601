...
//    static String jobdatakey = LoginJobOffererActivity.myID + "_jobdataset";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        integerDeque.push(R.id.item_mylist);
        //load home fragment
        loadFragment(new Fragment_mylist());
                            ...
                            if (id == R.id.item_mylist){
                                ...
                                if (integerDeque.size() != 1){
                                    ...
                                    if (flag){
                                        ...
                                        //add home fragment in deque list
                                        integerDeque.addFirst(R.id.item_mylist);
    ...
    private Fragment getFragment(int itemId) {
        switch (itemId){
            ...
            case R.id.item_mylist:
                ...
                return new Fragment_mylist();
            //MENU 눌렀을 때
            case R.id.item_notice:
                bottomNavigationView.getMenu().getItem(1).setChecked(true);
                return new Fragment_notice();
            case R.id.item_jobOfferermenu:
                bottomNavigationView.getMenu().getItem(2).setChecked(true);
                return new Fragment_jobofferermenu();
        }
        bottomNavigationView.getMenu().getItem(0).setChecked(true);
        //return home fragment
        return new Fragment_mylist();
